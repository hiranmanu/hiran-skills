...
| `interview-prep` | 1.1.0 | Builds interview intel from a JD + company: research (incl. named interviewers), STAR answers, smart questions, intro, HR-screen basics. Multi-round aware — reconciles a prior round's transcript and carries prep forward. Scales from a 10-minute rapid brief to a full dossier. | [README](plugins/interview-prep/README.md) · [CHANGELOG](plugins/interview-prep/CHANGELOG.md) |
